"""
Django settings for gpt_chat project.
...
ROOT_URLCONF = 'gpt_chat.urls'

# gpt_chat/settings.py
...
WSGI_APPLICATION = 'gpt_chat.wsgi.application'
ASGI_APPLICATION = 'gpt_chat.asgi.application'
